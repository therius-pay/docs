...
<CardGroup cols={2}>
  ...
  <Card icon="triangle-exclamation" title="Exception Reasons">
    Set `exceptionReason` when a scheme exception applies — `"resubmission"` after a soft decline, `"incremental"` for an authorization increase, `"no_show"` for a hospitality no-show fee.
  </Card>
</CardGroup>
