---
title: "Continue After a 3DS Challenge"
sidebarTitle: "Resume a Pending Payment"
description: "Resume a payment paused for a 3DS challenge. Pass the sessionId from the pending_3ds response. No API key required."
